...
bot = telebot.TeleBot('7957420137:AAEA7HzJ__XzOtPlZbV0f7MkD4-4SDSF6Ms')
...
#  Join Official Channel @RitikXyz099
...
def start_bgmi_reply(message, target, port, time):
    ...
    response = f"CHUDAI start : {target}:{port} for {time}\nSEC Jabtak YE bgmi run krrha hai to iske bichme koi bgmi nahe Dalna Bhenchod"
    bot.reply_to(message, response)
...
Official Channel :- https://t.me/+TRmOsvb_MG84YWM9
'''
...
3. MAKE SURE YOU JOINED https://t.me/RITIKXYZ24X7 OTHERWISE NOT WORK
